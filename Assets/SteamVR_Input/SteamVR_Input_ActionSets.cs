...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_publicspeech p_publicspeech;
        ...
        public static SteamVR_Input_ActionSet_publicspeech publicspeech
        {
            get
            {
                return SteamVR_Actions.p_publicspeech.GetCopy<SteamVR_Input_ActionSet_publicspeech>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_publicspeech = ((SteamVR_Input_ActionSet_publicspeech)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_publicspeech>("/actions/publicspeech")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.publicspeech};
        }
    }
}
